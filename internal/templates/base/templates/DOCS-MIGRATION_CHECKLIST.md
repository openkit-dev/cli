...
- [ ] Ensure each `memory/requirements/<feature>/HUB-<FEATURE>.md` links feature artifacts
- [ ] Ensure each `memory/sprint/Sprint-XX/HUB-SPRINT-XX.md` links sprint artifacts
